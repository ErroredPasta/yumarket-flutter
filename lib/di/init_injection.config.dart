...
import 'package:yumarket_flutter/review/domain/repository/review_repository.dart'
    as _i6;
import 'package:yumarket_flutter/review/ui/review_bloc.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.ReviewRepository>(
        () => _i7.ReviewRepositoryImpl(gh<String>(instanceName: 'storeId')));
    gh.factory<_i8.ItemRepository>(
        () => _i9.ItemRepositoryImpl(gh<String>(instanceName: 'storeId')));
    gh.factory<_i10.ReviewBloc>(
        () => _i10.ReviewBloc(gh<_i6.ReviewRepository>()));
    gh.factory<_i11.OrderRepository>(
        () => _i12.OrderRepositoryImpl(gh<String>(instanceName: 'storeId')));
    gh.factory<_i13.OrderBloc>(
        () => _i13.OrderBloc(gh<_i11.OrderRepository>()));
    gh.factory<_i14.ItemManageBloc>(
        () => _i14.ItemManageBloc(gh<_i8.ItemRepository>()));
    gh.factory<_i15.LoginBloc>(() => _i15.LoginBloc(gh<_i4.AuthRepository>()));
